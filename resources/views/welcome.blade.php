...
<head>
    ...
    <title>Conciviles App</title>

    <!-- CSS  -->
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="{{ asset('/principal/css/materialize.css') }}" type="text/css" rel="stylesheet" media="screen,projection"/>
...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br><br>
        <h1 class="header center orange-text">Bienvenido a Conciviles</h1>
        <div class="row center">
            <h5 class="header col s12 light">Sistema de elaboración de reportes e informes de incidencias</h5>
        </div>
        <div class="row center">
...
<script src="{{ asset('/principal/js/materialize.js') }}"></script>
<script src="{{ asset('/principal/js/init.js') }}"></script>
